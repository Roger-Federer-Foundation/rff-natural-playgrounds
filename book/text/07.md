...
**Identify participants**: Use [Tool 1: Partner Finder](06-01.html){:.show-page-number} as a guide to identify as many people as possible to attend the workshop. There should be at least 1 or 2 people per category.
...
**Identify participants**: Invite all participants that attended the Exploration Workshop and invite all partners and stakeholders that were identified in [Tool 1: Partner Finder](06-01.html){:.show-page-number} in the Exploration Workshop.
...
> - 9:40am
>
> Before the workshop, write out the summary of [Tool 3: Playground Dreams](06-03.html){:.show-page-number} on twelve separate pieces of large paper. Each of the categories, for example Gross Motor Play, is to be written on its own paper with the corresponding suggestions from the Exploration Workshop written underneath.
>
