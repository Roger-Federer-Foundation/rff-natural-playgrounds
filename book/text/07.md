...
{% include youtube
    id="hhutBzS8_8s"
    image="youtube-hhutBzS8_8s.jpg"
    link="https://www.youtube.com/watch?v=hhutBzS8_8s"
    description="[Video: Workshop facilitation tips](https://www.youtube.com/watch?v=hhutBzS8_8s){:.show-url}"
%}
...
In the [Section 1](01.html){:.show-page-number} of the toolkit, you will find information to use when advocating. Depending on the audience, venue and the amount of time available, you should plan your talk to cover the importance of play in child development, and natural playgrounds as a solution to providing play opportunities to children at a nominal cost.
...
There are two **workshops**{:data-term="Participatory Workshop"} that cover the tools. At the end of each workshop, a task team is elected to summarise the information gathered in the workshop.
...
*   Reading through the necessary tools in the [Toolbox](06-00.html){:.show-page-number} and these instructions for this workshop in the Facilitator’s Guide.

**Identify participants**: Use [Tool 1: Partner Finder](06-01.html){:.show-page-number} as a guide to identify as many people as possible to attend the workshop. There should be at least one or two people per category.

**Identify a venue**: Find a venue that is in the community and close to the existing playground you want to update or the site for the new playground.

**Arrange the workshop**: Make necessary arrangements for the workshop, such as refreshments, meals, stationery, and devices pre-loaded with the Natural Playground Toolkit. Arrange for a facilitator and two or three note takers. Remember to check for any dietary requirements of participants and cater for the special needs of people with disabilities.
...
> - 10:10am
>
> Use [Tool 3: Playground Dreams](06-03.html){:.show-page-number} to explore what you want to include in your playground.
> 
...
> - 10:40am
>
> Use [Tool 1: Partner Finder](06-01.html){:.show-page-number} to define who has an interest or investment in your playground. 
> 
> Divide participants into small groups of approximately five people. Make sure participants understand the concept of [brainstorming](02.html#brainstorm){:.show-page-number}. Each small group follows the instructions on the tool. Each small group provides feedback to the bigger group. Note takers should compile a combined list of ideas from the group feedback.
> 
> ##### 6.  Tea break
> - 30 minutes
> - 11:10am
...
> - 11:40am
>
> Use [Tool 2: Playground Map](06-02.html){:.show-page-number} to explore how people experience the playground. 
>
> Divide participants into small groups of approximately five people. Each small group follows the instructions on the tool. Each small group provides feedback to the bigger group. Note takers should compile a combined list of ideas from the group feedback.
> 
> ##### 8.  Lunch
...
> - 1:25pm
> 
> Use [Tool 4: Resource Inventory](06-04.html){:.show-page-number} to explore what resources are available.
> 
...
> - 2:25pm
>
> Use [Tool 5: Issue Finder](06-05.html){:.show-page-number} to explore the legal and practical issues of creating a natural playground.
> 
> Divide participants into small groups of approximately five people. Each small group follows the instructions on the tool. Each small group provides feedback to the bigger group. Note takers should compile a combined list of ideas from the group feedback.
> 
...
> - 2:55pm
> 
> Use [Tool 6: Risk–Benefit Assessment](06-06.html){:.show-page-number} to explore the risks and benefits of loose part play.
> 
> Divide participants into small groups of approximately five people. Each small group follows the instructions on the tool. Each small group provides feedback to the bigger group. Note takers should compile a combined list of ideas from the group feedback.
> 
> ##### 12.  Tea break
...
**Identify participants**: Invite all participants that attended the Exploration Workshop and invite all partners and stakeholders that were identified using [Tool 1: Partner Finder](06-01.html){:.show-page-number} in the Exploration Workshop.
...
> 
> -   Group 1 get the summary of [Tool 2: Playground Map](06-02.html){:.show-page-number}
> -   Group 2 get the summary of [Tool 3: Playground Dreams](06-03.html){:.show-page-number}
> -   Group 3 get the summary of [Tool 4: Resource Inventory](06-04.html){:.show-page-number}
> -   Group 4 get the summary of [Tool 5: Issue Finder](06-05.html){:.show-page-number}
> 
...
> - 9:40am
>
> Before the workshop, write out the summary of [Tool 3: Playground Dreams](06-03.html){:.show-page-number} on twelve separate pieces of large paper. Each of the categories, (for example, Gross Motor Play,) is written on its own sheet of paper with the corresponding suggestions from the Exploration Workshop written underneath.
>
> Participants must vote for one item in each category by writing their initials next to it. Facilitator is to count the votes, determine a winner in each category, and mark it clearly. If there is a draw, simply revote that one category. Make sure to assure participants that the other ideas are not thrown out, they are simply reserved for another time.
>
> ##### 5.  Tea break
> 
> - 30 minutes
...
> - 10:40am
>
> Use [Tool 7: Formulating Objectives](06-07.html){:.show-page-number} to formulate smart objectives by describing exactly what you want to achieve.
>
...
> - 11:40am
> 
> Use [Tool 8: Activity Plan](06-08.html{:.show-page-number}) to see that everything you have planned can be completed on time and on budget.
> 
> Divide participants into twelve groups. Each group gets one of the twelve priorities to work with (or more than one if there are less than twelve groups). Make sure participants understand what they need to do by going through the tool with them, using examples. Let each group complete the tool by brainstorming. Remind them that they must keep the information discussed earlier (results of Exploration Workshop) in mind when writing up objectives. Each small group provides feedback to the bigger group.
>
...
> - 12:20pm
> 
> Give a short overview of the concepts in [Section 5](05.html){:.show-page-number}. Use [Tool 9: Monitoring Summary](06-09.html){:.show-page-number} to see that everything you planned gets done.
>
> Divide participants into small groups of approximately five people. Make sure participants understand what they need to do by going through the tool with them, using examples. Let each group complete the tool by brainstorming. Remind them that they must keep the information discussed earlier (results of Exploration Workshop) in mind when writing up objectives. Each small group provides feedback to the bigger group. Discuss Tools 10, 11 and 12 with the group and explain when to use them.
{:.box.pdf-wide}
...
> Dear Parents
> 
> We send this letter in case you missed our last meeting where we discussed the new way of play we are embracing at our school.
> 
...
> 
> Loose parts play will happen in and out of class time. It will be a chance for children to play freely with friends, investigate, discover, explore, create, use lots of trial and error to learn for themselves, learn to make their own judgments about adventurous play, and recognising safety limits.
> 
...
> *   It is important to have enough time and good places to play freely.
> 
...
> The Most Fantastic Pre-School recognises that:
> 
> *   Children will naturally create and/or seek out challenging situations.
> *   Some children may have accidents, get dirty, wet or upset when playing.
> *   Any potential risk of harm to children needs to be balanced with the benefits that free play offers.
> 
> We will do our best to avoid children getting hurt by providing supervision for the play opportunities that we provide.
> 
...
Coaches assist participants to develop to their full potential. They help participants grow and develop a skill by analysing their performances, instructing in relevant skills and by providing encouragement. Coaches should be:
...
{% include figure
   markdown="| Coaching do’s                              | Coaching don’ts                             |
|--------------------------------------------|---------------------------------------------|
...
| Challenge participants to meet their goals. | Be afraid to give feedback to participants.  |"
   reference="Figure 18"
   caption="The do’s and don’ts of coaching"
   description="The do’s and don’ts of coaching"
   class="fixed"
%}

### Coaching model for the natural playground process

There are many different coaching models in circulation. The one that will work well in the natural playground process is the GROW model that stands for **G**oal, **R**eality, **O**ptions, **W**ay forward. It provides a structure for coaching discussions. The model places the responsibility for development on the participant. They must come to the coaching session with goals for discussion.
...
| Stage 2 **R**eality: | The **coach** uses questioning and listening skills to help the participant define the issues that need to be addressed. The **participant** talks about the reality they are facing (issues and obstacles) and writes it down. |
...
Unprepared participants are a frustration to themselves and the members who did prepare. Each member should review the material and make notes on insights they had and questions they want to discuss
