---
title: "Testing colours with section-1 content"
style: chapter purple
---

{% include metadata %}

# **Testing colours** with section-1 content

## The importance of play

{% include definition term="attitude" %}

Play develops skills, habits and **attitudes**{:data-term="attitude"} that stay with children for the rest of their lives.

[Video 2: The importance of play]

Play in early childhood has a strong and lasting influence on a child’s health, wellbeing, and long‐term development. Studies show that early play experiences shape a child’s physical growth, capacity for learning, chances of finishing school, future employability, and even income.[^2] Through play, children develop the brain pathways that are needed to further learn and grow.
...
> {:.icon-key}
> 
> **90%** of critical brain development happens before **age five**.[^3]
> {:.icon-brain}
{:.fact-box}
...
> This reference is incomplete and the link is broken.
...
![](../{{ site.image-set }}/development-hierarchy.jpg)
...
{% include figure
   ...
   reference="Figure 4"
   caption="Through play children create new things, solve problems and form an understanding of the world."
   description="Through play children create new things, solve problems and form an understanding of the world."
...
Play develops all the skills that children need to be ready for school and life.

{% include figure
   images="when-children-play.jpg"
   reference="Figure 5"
   caption="When children play they are:"
   description="When children play they are:"
%}
...
{% include figure
   markdown="| 0 - 12 months | 1 - 2 years | 2 -3 years | 3 - 4 years | 4 - 5 years | I enjoy:             |
|---------------|-------------|------------|-------------|-------------|-----------------------------------|
...
Free play has fewer rules, which leaves more room for self-discovery, imagination and creativity. Watch the video below to see the benefits and possibilities of outdoor free play.

[Video 3: Outdoor free play]

## Playground safety

### How to keep a safe playground

Follow these guidelines to ensure that your playground is safe:
...
-   Nothing higher than 1.5m
-   Nothing closer than 2m from each other
...
-   An outdoor play area of adequate size must be provided for use by every child on the premises including an outdoor play area of a minimum of at least 5m<sup>2</sup> per child on the premises and separate play areas for children between the ages of 0‐2 years and those between the ages of 3‐6 years.
...
![](../{{ site.image-set }}/playground-concept.jpg)

### Natural Playgrounds vs Traditional Playgrounds

Natural Playgrounds are different to traditional playgrounds in a number of ways.
...
| Fixed equipment is intended to be used in a certain way                                          | Loose parts, pathways, sand, water, trees and plants can be reimagined and redesigned by children daily |
| Become boring over time                                                                          | Become more engaging over time as the children’s skills improve                                         |
| Are inflexible to children’s ideas                                                               | Children can build their ideas in the real world                                                        |
| Purpose is physical fitness and so they are not always accessible for differently-abled children | Play can be imaginative and is accessible to all children                                               |
...
> #### Layout
> 
> -   Make different play spaces for different kinds of activities
> -   Spread play spaces throughout the playground ‐ don’t squash them all together in only one area
> -   Play spaces can be separated by paths
> -   Incorporate the natural elements (trees or rocks) as part of play spaces. If you do not have trees, plant some for future children. It can be a project where you involve the kids to help protect and water the trees. Find out from your closest nursery what trees grows fast and make a limited mess to clean up.
> -   Well‐designed borders that demarcate or separate play spaces can offer as much (and sometimes more) play value than the play space itself. Wherever possible, incorporate natural borders (boulders, stumps, logs, shrubs etc.) of varying sizes and diverse materials.
> -   Place larger or more popular play spaces (climbing structures, sand play areas) where they are easy to supervise. Make sure the supervisor can see all areas where children can play.
{:.box}
...
> -   Consider a small vegetable garden where children are involved in the planting and watering. Research shows that children are more likely to eat vegetables that they helped to grow themselves.
> -   Make a “river bed” with stones. Select pebbles and stones that are an age-appropriate size.
> -   Having a “table” or flat item in the sand play area encourages children not to carry the sand away from the sandpit.
> -   Placing rocks and boulders in the playground provides challenging routes, sitting places or climbing opportunities
> -   Trees and shrubs can be used as windbreaks, to provide shade and moderate the temperature, reduce glare, separate play spaces and can be educational tools. Trees that shed their leaves can block out the sun in summer but allow the warmth in winter sun. Plants can also be used to create hidden spaces.
{:.box}
...
Use [Tool 4](06.html#tool-4-planning) to plan your natural playground and request donations for equipment.
{:.tip-box}
...
-   Is it flexible or sturdy enough that it be used and reused in different ways without breaking or becoming dangerous?
...
-   Wooden coins (slices of wood about 3cm thick)
