...
{% if site.output == 'app' %}
    ...
    {% include video
        file="npt-video-2.mp4"
        image="youtube-Jn3ruzb2n_8.jpg"
        description="Video: The importance of play"
    %}
...
{% if site.output == 'app' %}
    ...
    {% include video
        file="npt-video-3.mp4"
        image="youtube-Flz644RD61E.jpg"
        description="Video: Outdoor free play"
    %}
...
{% include definition term="Loose parts" class="shift-down-4" %}
